...
public class GenderConfig {
    ...
    public static class ConfigData {
        ...
        public ConfigData() {
            ...
            villagerSettings.maleChance = 47;
            villagerSettings.femaleChance = 47;
            villagerSettings.enabled = true;
    ...
    public static class VillagerSettings {
        ...
        public int maleChance = 47;
        public int femaleChance = 47;
        public List<String> enabledVillagers = new ArrayList<>(Arrays.asList("minecraft:villager"));
    }
    ...
    public static void load() {
        if (!configPath.toFile().exists()) {
            ...
            try (Reader reader = new FileReader(configPath.toFile())) {
                ...
                if (root.has("villagerSettings")) {
                    JsonObject villager = root.getAsJsonObject("villagerSettings");
                    if (villager.has("enabled")) data.villagerSettings.enabled = villager.get("enabled").getAsBoolean();
                    if (villager.has("maleChance")) data.villagerSettings.maleChance = villager.get("maleChance").getAsInt();
                    if (villager.has("femaleChance")) data.villagerSettings.femaleChance = villager.get("femaleChance").getAsInt();
                    if (villager.has("enabledVillagers")) {
                        data.villagerSettings.enabledVillagers = new ArrayList<>();
                        for (JsonElement e : villager.getAsJsonArray("enabledVillagers")) {
                            data.villagerSettings.enabledVillagers.add(e.getAsString());
                        }
                    }
                }
    ...
    public static boolean isVillagerEnabled() { return data.villagerSettings.enabled; }
    public static int getVillagerMaleChance() { return data.villagerSettings.maleChance; }
    public static int getVillagerFemaleChance() { return data.villagerSettings.femaleChance; }
    public static List<String> getEnabledVillagers() { return data.villagerSettings.enabledVillagers; }
    ...
    public static void setDisplayRadius(int value) { data.settings.displayRadius = value; }
    public static void setAllowMaleMaleBreed(boolean value) { data.settings.allowMaleMaleBreed = value; }
    public static void setAllowFemaleFemaleBreed(boolean value) { data.settings.allowFemaleFemaleBreed = value; }
    public static void setAllowSterileBreed(boolean value) { data.settings.allowSterileBreed = value; }
    public static void setVillagerEnabled(boolean value) { data.villagerSettings.enabled = value; }
    ...
    public static String[] getRandomVillagerGender() {
        int male = data.villagerSettings.maleChance;
        int female = data.villagerSettings.femaleChance;
        int total = male + female;
        ...
        int roll = new Random().nextInt(100);
        String gender = roll < male ? "male" : "female";
        
        return new String[]{gender, "false"};
    }
