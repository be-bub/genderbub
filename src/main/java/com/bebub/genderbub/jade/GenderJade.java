    ...
    public static class GenderProvider implements IEntityComponentProvider {
        ...
        public void appendTooltip(ITooltip tooltip, EntityAccessor accessor, IPluginConfig config) {
            ...
            if (sterile) {
                color = 0xAAAAAA;
                if (isBaby) {
                    key = isVillager || isZombieVillager ? "genderbub.villager.sterile.baby" : "genderbub.gender.sterile.baby";
                } else {
                ...
                if (isBaby) {
                    key = isVillager || isZombieVillager ? "genderbub.villager.baby" : "genderbub.gender.baby";
                } else {
                    if (isVillager || isZombieVillager) {
