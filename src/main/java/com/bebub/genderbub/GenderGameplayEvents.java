...
public class GenderGameplayEvents {
    ...
    public static String getGender(LivingEntity entity) {
        if (ExternalMobHandler.isIceFireDragon(entity)) {
            String nbtGender = ExternalMobHandler.getIceFireDragonGender(entity);
            if (nbtGender != null) {
                return nbtGender;
            }
        }
    ...
    public static boolean shouldBeSterile(RandomSource random) {
    ...
    public void onEntityJoinWorld(EntityJoinLevelEvent event) {
        ...
        if (ExternalMobHandler.isIceFireDragon(entity)) {
            String correctGender = ExternalMobHandler.getIceFireDragonGender(entity);
